...
if (!empty($_FILES["profilePicture"]["name"])) {
    ...
    if (move_uploaded_file($file_tmp, $target_file)) {
        ...
        $sql1 = "UPDATE admin SET fullname='$fullname', fathersname='$fatherName', mothersname='$motherName', 
    ...
    $result = $conn->query("SELECT profilepicture FROM admin WHERE userid='$userid'");
