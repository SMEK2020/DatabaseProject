...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            echo "<script>alert('ভুল পাসওয়ার্ড!'); window.location.href='Slogin.php';</script>";
        }
    } else {
        echo "<script>alert('এই ইমেইল দিয়ে কোনো অ্যাকাউন্ট পাওয়া যায়নি!'); window.location.href='Slogin.php';</script>";
    }
}
?>
